...
const SettingsPage = () => {
  ...
  return (
    <div className="container container-p mx-auto pt-24 pb-10 max-w-6xl bg-base-100">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-4 sm:grid-cols-6 lg:grid-cols-8 gap-2">
          {THEMES.map((t) => (
            ...
            >
              {theme === t ? (
                <div className="absolute p-2 -right-[8%] -top-[12%] bg-green-500 z-10 rounded-full animate-bounce">
              ...
              <span
                className={`text-xs font-medium truncate w-full text-center text-base-content`}
              >
